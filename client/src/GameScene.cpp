...
void GameScene::init()
{
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_ENTER, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
        Request request = {0};
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_UP, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
    try {
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_UP, LE::JUST_RELEASED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id = _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
        request.header.Action = asChar(ActionCode::UP);
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_DOWN, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_DOWN, LE::JUST_RELEASED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
        request.header.Action = asChar(ActionCode::DOWN);
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_LEFT, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_LEFT, LE::JUST_RELEASED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
        request.header.Action = asChar(ActionCode::LEFT);
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_RIGHT, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_RIGHT, LE::JUST_RELEASED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
        request.header.Action = asChar(ActionCode::RIGHT);
    ...
    _eventManager->addEventListener({LE::KEYBOARD, LE::LE_KEY_SPACE, LE::JUST_PRESSED, false}, [&](LE::IEngine &engine, float dt) {
    try {
        int id =  _engine->getGame()->getClientBroker()->getECSId();
        Request request = {0};
